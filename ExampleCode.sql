...
FROM 'O:\Research Paper Gate\Papers of Hume AI\MPI_Directory_by_Establishment_Name.csv'
...
FROM 'O:\Research Paper Gate\Papers of Hume AI\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
CREATE TABLE meat_poultry_egg_inspect_backup AS
SELECT *,
       '2024-10-10'::date AS reviewed_date
FROM meat_poultry_egg_inspect;
